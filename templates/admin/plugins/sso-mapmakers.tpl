<div class="row">
	<div class="col-lg-9">
		<div class="panel panel-default">
			<div class="panel-heading">Mapmakers Social Authentication</div>
			<div class="panel-body">
				<form role="form" class="sso-mapmakers-settings">
					<p>
						Create a <strong>Mapmakers OAuth Client</strong> via the
						<a href="https://oauth.mapmakers.com/client/new">OAuth Portal</a> and then paste
					...
					<p class="help-block">
						The appropriate "Redirect URI" is your NodeBB's URL with `/auth/mapmakers/callback` appended to it.
					</p>
					<div class="checkbox">
...
<script>
	require(['settings'], function(Settings) {
		Settings.load('sso-mapmakers', $('.sso-mapmakers-settings'));

		$('#save').on('click', function() {
			Settings.save('sso-mapmakers', $('.sso-mapmakers-settings'), function() {
				app.alert({
					type: 'success',
					alert_id: 'sso-mapmakers-saved',
